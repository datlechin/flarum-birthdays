...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return calculateAge; });
...
/* harmony import */ var _components_ChangeBirthdayModal__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/ChangeBirthdayModal */ "./src/forum/components/ChangeBirthdayModal.js");
/* harmony import */ var _helpers_calculateAge__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./helpers/calculateAge */ "./src/forum/helpers/calculateAge.js");
...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('datlechin/flarum-birthdays', function () {
  ...
  flarum_common_models_User__WEBPACK_IMPORTED_MODULE_2___default.a.prototype.canEditOwnBirthday = flarum_common_Model__WEBPACK_IMPORTED_MODULE_3___default.a.attribute('canEditOwnBirthday');
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_forum_components_UserCard__WEBPACK_IMPORTED_MODULE_11___default.a.prototype, 'infoItems', function (items) {
    ...
    var dateFormat = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('dateFormat') || 'DD MMMM YYYY';
    var dateNoneYearFormat = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('dateNoneYearFormat') || 'DD MMMM';
    var birthday = user.birthday();
    var age = Object(_helpers_calculateAge__WEBPACK_IMPORTED_MODULE_15__["default"])(birthday);
    moment__WEBPACK_IMPORTED_MODULE_13___default.a.locale(userLocale);
    if (birthday === null) return;
    if (user.showDobDate() && user.showDobYear()) birthday = moment__WEBPACK_IMPORTED_MODULE_13___default()(birthday).format(dateFormat);else if (user.showDobDate() === true && user.showDobYear() === false) birthday = moment__WEBPACK_IMPORTED_MODULE_13___default()(birthday).format(dateNoneYearFormat);else return;
    ...
    if (this.user.canEditOwnBirthday()) {
      items.add('changeBirthday', m(flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
        ...
        onclick: function onclick() {
          return flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.modal.show(_components_ChangeBirthdayModal__WEBPACK_IMPORTED_MODULE_14__["default"]);
        }
